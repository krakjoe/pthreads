...
if test "$PHP_PTHREADS" != "no"; then
	...
	PHP_NEW_EXTENSION(pthreads, php_pthreads.c src/globals.c src/prepare.c src/monitor.c src/store.c src/resources.c src/handlers.c src/object.c, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1)
